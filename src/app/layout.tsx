...
export const metadata: Metadata = {
  title: "TechShop - Venture Capital & Early-Stage Tech Investment",
  description: "Premium venture capital firm investing in transformative early-stage technology companies. Strategic funding and expert guidance for founders.",
  keywords: "venture capital, tech investment, startup funding, Series A, Series B, innovation, tech founders",
  metadataBase: new URL("https://techshop.com"),
  alternates: {
    canonical: "https://techshop.com"
  },
  openGraph: {
    title: "TechShop - Transform Tech Ventures",
    description: "Investment partner for visionary tech founders. Providing capital, mentorship, and global reach.",
    url: "https://techshop.com",
    siteName: "TechShop",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_340noUjwh7KpDNuxXriz4d54I9H/uploaded-1764144179352-mnnebd0x.jpg",
      alt: "TechShop Venture Capital Office"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "TechShop - Venture Capital for Tech Innovators",
    description: "Invest in breakthrough technology companies",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_340noUjwh7KpDNuxXriz4d54I9H/uploaded-1764144179352-mnnebd0x.jpg"]
  },
  robots: {
    index: true,
    follow: true
